 ...
 *
 * Example:
 * [object] call vbw_fnc_loadoutAction
 *
 * Public: [Yes/No]
 */
...
params [
    ...
    ["_camoType",0],
    ["_weaponType",0],
	"_vbwMachineGun4Param"
];

_vbwMachineGun4Param = "vbwPlayedNation" call BIS_fnc_getParamValue;
...
_object addAction ["<t color='#74FF33'>MG1</t>",{[player, "mg1", 1, 0, 0, false] call pb21_fnc_bundeswehr;},nil,1.5,true,true,"","true",5,false,""];
_object addAction ["<t color='#74FF33'>MG2</t>",{[player, "mg2", 1, 0, 0, false] call pb21_fnc_bundeswehr;},nil,1.5,true,true,"","true",5,false,""];
...
if (_vbwMachineGun4Param == 2) then {
