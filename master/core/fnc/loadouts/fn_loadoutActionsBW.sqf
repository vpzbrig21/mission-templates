...
_object addAction ["<t color='#DF0101'>MG1 (Rehinmetall MG3)</t>",{[player, "mg1", 1, 0, 0, false] call pb21_fnc_bundeswehr;},nil,1.5,true,true,"","true",5,false,""];
...
_object addAction ["<t color='#00BFFF'>Pionier</t>",{[player, "sql", 2, 0, 1, false] call pb21_fnc_bundeswehr;},nil,1.5,true,true,"","true",5,false,""];
